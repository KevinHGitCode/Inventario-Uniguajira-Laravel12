<div id="modalDarDeBajaBienSerial" class="modal">
    <div class="modal-content modal-content-large scrollable-content">
        ...
        <form id="formDarDeBajaBienSerial" class="form-container" autocomplete="off"
            ...
            <div class="form-section">
                ...
                {{-- 2) Los demás campos en 2 columnas --}}
                <div class="form-fields-grid">
                    <div>
                ...
                <div class="form-fields-grid">
                    <div class="form-field-full">
                        ...
                        <textarea id="darDeBajaSerialDescripcion" class="form-input" rows="3" disabled></textarea>
                    </div>
                </div>
            </div>
